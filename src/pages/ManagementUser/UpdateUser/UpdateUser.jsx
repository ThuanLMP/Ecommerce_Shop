...
const listNav = ['Dashboard', 'User', 'Update User']
...
export default function UpdateUser() {
    ...
    const updateUser = async (dataUser, resetForm) => {
        setLoading(true)
        try {
            const res = await userApi.updateUser(dataUser,user.id)
            if (res.status === 200) {
    ...
    return (
        <AdminLayout>
            ...
            <Box component='form' onSubmit={formik.handleSubmit} sx={{
                ...
                <h2 style={{ marginLeft: '30px', marginTop: '30px' }}>Update User</h2>
                <LoadingButton
                    type='submit'
                    loading={loading}
                    sx={{
